const char btr2initBtrJs_file[] PROGMEM = R"=====(
  ...
  `
    ...
    batteryStats.appendChild(btrSt.divVoltage);
    ...
    batteryStats.appendChild(btrSt.divVoltDiff);
    ...
    batteryStats.appendChild(btrSt.divCurrent);
    ...
    batteryStats.appendChild(btrSt.balanceCap);
    ...
    batteryStats.appendChild(btrSt.rateCap);
    ...
    batteryStats.appendChild(btrSt.chrgMosfet);
    ...
    batteryStats.appendChild(btrSt.dsChrgMosfet);
    ...
    batteryStats.appendChild(btrSt.stateChrg);
    ...
    batteryStats.appendChild(btrSt.currentTime);
